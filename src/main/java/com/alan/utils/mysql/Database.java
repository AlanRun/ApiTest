...
public abstract class Database {
     ...
     * @return result code, see {@link PreparedStatement#executeUpdate()}
     * @throws SQLException If the query cannot be executed
     */
     ...
     *
     * @param update Update to be run
     * @return {@link CompletableFuture} containing result code, see {@link PreparedStatement#executeUpdate()}
     * internally throws {@link SQLException}           If the query cannot be executed
