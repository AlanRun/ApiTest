...
public class CheckPoints {
    ...
    private static Logger logger = Logger.getLogger(CheckPoints.class);
...
//                }
    ...
    public static String covertToAviatorString(String value) {
        return "'" + value + "'";
    }
    ...
    public static void main(String args[]) {
        ...
        //日期比较
        Map<String, Object> env7 = new HashMap<String, Object>();
